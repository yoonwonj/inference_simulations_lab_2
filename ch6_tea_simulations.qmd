...
So, here, DELTA is the difference is the tea ratings, on average, between the two conditions, in likert scale points.
...
Now, make a new data frame (call it tea_data_highn) with an N of 48, or something higher if you want?

```{r}

```

To do: OK, look at these data frames. How long are they, what are the column names? Look at them in your console by copy and pasting the variable names into R.
...
**Bonus** What happens if you run it again? Try varying the variance / mean of the effect when you change the "delta" and "sigma" values in the data simulation.
